...
class ApiCloudSettingsActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (p.getString("conversation_provider", "gemini")) {
            "openrouter" -> b.providerOpenRouter.isChecked = true
            "groq" -> b.providerGroq.isChecked = true
            "deepseek" -> b.providerDeepseek.isChecked = true
            else -> b.providerGemini.isChecked = true
        }
        ...
        b.saveButton.setOnClickListener {
            ...
            val provider = when (b.providerGroup.checkedRadioButtonId) {
                b.providerOpenRouter.id -> "openrouter"
                b.providerGroq.id -> "groq"
                b.providerDeepseek.id -> "deepseek"
                else -> "gemini"
            }
            p.edit().putString("conversation_provider", provider).apply()
