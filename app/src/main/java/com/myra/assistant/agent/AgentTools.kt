...
class AgentToolRegistry(definitions: List<ToolDefinition> = defaults()) {
    ...
    companion object {
        fun defaults() = listOf(
            ...
            ToolDefinition("long_press", ToolCapability.LONG_PRESS, "ACCESSIBILITY", true, ToolRisk.MEDIUM, "semantic_state_change"),
            ToolDefinition("swipe", ToolCapability.SWIPE, "ACCESSIBILITY", true, ToolRisk.MEDIUM, "content_or_position_change"),
            ...
            ToolDefinition("clear_text", ToolCapability.CLEAR_TEXT, "ACCESSIBILITY", true, ToolRisk.MEDIUM, "field_value_empty"),
            ToolDefinition("press_enter", ToolCapability.PRESS_ENTER, "ACCESSIBILITY", true, ToolRisk.MEDIUM, "screen_or_input_state_change"),
            ...
            ToolDefinition("switch_app", ToolCapability.SWITCH_APP, foregroundRequired = false, verificationStrategy = "foreground_package_matches"),
            ToolDefinition("back", ToolCapability.BACK, "ACCESSIBILITY", true, verificationStrategy = "navigation_changed"),
            ToolDefinition("home", ToolCapability.HOME, "ACCESSIBILITY", false, verificationStrategy = "launcher_foreground"),
