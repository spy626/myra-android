...
class WorkspaceAiHandoffTest {
    ...
    @Test fun preparedHandoffQuotesBoundedSourceAndNeverWrites() {
        ...
        assertTrue(draft.prompt.contains("Relevant project structure"))
        assertFalse(draft.prompt.contains("other file contents are shared):\n- notes.md"))
        assertTrue(draft.projectContext.projectedChars < 500)
        ...
        assertTrue("Instruction envelope should stay small", draft.prompt.length <= 3_500)
